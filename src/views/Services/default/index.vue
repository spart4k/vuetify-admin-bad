                ...
                <v-expansion-panel-header color="rgb(240 240 240)">
                  <table class="service-group-header">
                    ...
                    <tr>
                      ...
                      <td width="">
                        <v-icon v-if="!service1C.moderation" color="red" small class="mr-2">mdi-exclamation-thick
                        </v-icon>
                ...
                <v-expansion-panel-content>
                  <v-expansion-panels>
                    <v-expansion-panel v-for="(service2C) in service1C.Children" :key="service2C.id">
                      <v-expansion-panel-header color="rgb(215 215 215)">
                        <table class="service-group-header">
                          ...
                          <tr>
                            ...
                            <td width="">
                              <v-icon v-if="!service2C.moderation" color="red" small class="mr-2">
                      ...
                      <v-expansion-panel-content>
                        <v-expansion-panels>
                          <v-expansion-panel v-for="(service3C) in service2C.Children" :key="service3C.id"
                                             color="rgb(20 21 211)">
                            <v-expansion-panel-header color="rgb(190 190 190)">
                              <table class="service-group-header">
                                ...
                                <tr>
                                  ...
                                  <td width="">
                                    <v-icon v-if="!service3C.moderation" color="red" small class="mr-2">
                                      mdi-exclamation-thick
                                    </v-icon>
                            ...
                            <v-expansion-panel-content>
                              <v-expansion-panels readonly>
                                <v-expansion-panel v-for="(service4C) in service3C.Children" :key="service4C.id"
                                                   color="rgb(20 21 211)">
                                  <v-expansion-panel-header color="rgb(165 165 165)">
                                    <table class="service-group-header">
                                      ...
                                      <tr>
                                        ...
                                        <td width="">
                                          <v-icon v-if="!service4C.moderation" color="red" small class="mr-2">
                                            mdi-exclamation-thick
                                          </v-icon>
                                          <!-- <v-icon small class="mr-2" @click.stop="addClass(service)">mdi-plus</v-icon> -->
                                          <v-icon small class="mr-2" @click.stop="editItem(service4C)">mdi-pencil
                                          </v-icon>
