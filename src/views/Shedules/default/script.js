...
import {masters, schedules} from '@/api'
...
export default {
    ...
    data() {
        return {
            ...
            shedulesType: 1,
            dayOfWeek: 1,
            regularSchedule: [{intervals: [], workspace_id: null, services: [], express: false}, {
                intervals: [],
                workspace_id: null,
                services: [],
                express: false
            }, {intervals: [], workspace_id: null, services: [], express: false}, {
                intervals: [],
                workspace_id: null,
                services: [],
                express: false
    ...
    methods: {
        ...
        async getServices() {
            ...
            const masterServices = await schedules.getServices(requestData)
        ...
        async getWorkspace() {
            ...
            const masterWorkspace = await schedules.getWorkspace(requestData)
        ...
        async getFullShedules() {
            ...
            for (let i = 0; i < 7; i++) {
                ...
                const mastersShedulesDataMonth = await schedules.getMonth(this.editedItem.id, month, currentYearIndex)
        ...
        async requestEdit() {
            ...
            if (this.shedulesType === 1) {
                ...
                await schedules.updateRegular(newDate.getFullYear(), newDate.getMonth() + 1, newDate.getDate(), requestData)
                // гибкий
                ...
                await schedules.updateFlex(this.date.split('-')[0], this.date.split('-')[1], this.date.split('-')[2], requestData)
            }
